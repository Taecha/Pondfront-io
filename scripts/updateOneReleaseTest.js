...
assert.strictEqual(release.CURRENT.label, "Update 2", "current public label must be Update 2");
assert.ok(release.HISTORY.some((entry) => entry.label === "Update 1.01"), "Update 1.01 must remain in release history");
